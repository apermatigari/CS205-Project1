...
int main() {
    cout << "Welcome to Nine Men in a Trench solver." << endl;
    cout << "Choose the following options: " << endl;
    cout << "1. Enter your own puzzle" << endl;
    cout << "2. Use the default puzzle" << endl;
...
//  }
    ...
    if(chooseType == 2) {
        const int trenchNum = 10;
        const vector<int> recessPos = {3, 5, 7};
        const int totalSize = trenchNum + recessPos.size();

        vector<int> puzzle(totalSize, 0);
        puzzle[0] = 0;  // cell 1 empty
        puzzle[1] = 2;
        puzzle[2] = 3;
        puzzle[3] = 4;
        puzzle[4] = 5;
        ...
        Problem prob(puzzle, trenchNum, recessPos);
